package com.example.demo.securite.jwt;
import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.example.demo.Demo7Application;
import com.example.demo.securite.bean.User;
import com.example.demo.securite.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = Demo7Application.getCtx().getBean(UserService.class);
        ...
        String jwt= JWT.create()
                ...
                .sign(Algorithm.HMAC256(SecurityParams.SECRET));              // .sign(Algorithm.HMAC256(SecurityParams.SECRET));
